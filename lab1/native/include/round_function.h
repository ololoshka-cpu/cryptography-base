...
#define S_BLOCK_COUNT 8
#define S_BLOCK_ROWS 4
#define S_BLOCK_COLUMNS 16
#define S_BLOCK_SIZE (S_BLOCK_ROWS * S_BLOCK_COLUMNS)
#define E_TABLE_SIZE 48

const static size_t S_BLOCKS[S_BLOCK_COUNT][S_BLOCK_SIZE] = {
    //S1
    {
...
const static size_t E_TABLE[E_TABLE_SIZE] = {
    32,  1,  2,  3,  4,  5,
     4,  5,  6,  7,  8,  9,
     8,  9, 10, 11, 12, 13,
    12, 13, 14, 15, 16, 17,
